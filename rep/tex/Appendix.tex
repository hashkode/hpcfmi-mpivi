...
\centering
    ...
    \subfloat[Local rss-sum vs. world\_size]{
    	...
    	\hspace{0pt}}\\
    \caption{Vergleich der Ausführungsumgebungen NUC, RPi und HPC lokal mit dem Datensatz <small>, Teil 1/2}
	\label{fig:benchmarkDivSmall1}
\end{figure*}
...
\centering
    ...
    \subfloat[Local J-diff maxnorm vs. com\_interval]{
    	...
    	\hspace{0pt}}\\
    \caption{Vergleich der Ausführungsumgebungen NUC, RPi und HPC lokal mit dem Datensatz <small>, Teil 2/2}
	\label{fig:benchmarkDivSmall2}
\end{figure*}

\subsection{Benchmark Datensatz normal}

Die nachfolgenden Graphiken zeigen die Ergebnisse der Benchmarks für den Datensatz normal:

\begin{itemize}
	\item Vergleich der Ausführungsumgebungen HPC Cluster mit dem Datensatz <normal>, Teil 1/2~\autoref{fig:benchmarkHpcSmall1}
	\item Vergleich der Ausführungsumgebungen NUC, RPi und HPC lokal mit dem Datensatz <normal>, Teil 1/2~\autoref{fig:benchmarkDivSmall1}
	\item Vergleich der Ausführungsumgebungen HPC Cluster mit dem Datensatz <normal>, Teil 2/2~\autoref{fig:benchmarkHpcSmall2}
	\item Vergleich der Ausführungsumgebungen NUC, RPi und HPC lokal mit dem Datensatz <normal>, Teil 2/2~\autoref{fig:benchmarkDivSmall2}
\end{itemize}
