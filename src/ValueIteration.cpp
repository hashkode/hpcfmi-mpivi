...
namespace Backend {
    ...
    inline StateTuple ValueIteration::decodeState(int state, int nStars) {
        StateTuple stateTuple{.fuel = (int) (state / (nStars * nStars)), .desStar = (int) ((state % (nStars * nStars)) /
                                                                                           nStars), .curStar =
    ...
    inline float ValueIteration::calculateExpectedCost(Eigen::Map<Eigen::VectorXf> &j, Eigen::Map<SparseMatrixType> &p,
                                                       StateTuple &stateTuple, const int state, const int action,
                                                       const float alpha, const int maxU) {
    ...
    template<typename SparseMatrixType>
    inline float ValueIteration::updateBlock(const int blockStart, const int blockSize, Eigen::Map<Eigen::VectorXf> &j,
                                             Eigen::Map<SparseMatrixType> &p, Eigen::Map<Eigen::VectorXi> pi,
                                             const float alpha, const int maxF, const int nStars, const int maxU) {
    ...
    inline float ValueIteration::asyncValueIteration(Eigen::Map<Eigen::VectorXf> &j, Eigen::Map<SparseMatrixType> &p,
                                                     ...
                                                     const int nIteration, const int firstState, const int lastState) {
