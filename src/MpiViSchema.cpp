...
void MpiViSchema::calculateMetrics(std::vector<float> &j, std::vector<float> &jStar, MpiViUtility::ViParameters &viParameters, MpiViUtility::MpiParameters &mpiParameters, MpiViUtility::LogParameters &logParameters) {
